...
describe('RomanNumeral', () => {
  ...
  test('2300', () => {
    let number = new RomanNumeral(2300);
    expect(number.toRoman()).toBe('MMCCC');
  });

  test('2500', () => {
    let number = new RomanNumeral(2500);
    expect(number.toRoman()).toBe('MMD');
  });
  
  test('2700', () => {
    let number = new RomanNumeral(2700);
    expect(number.toRoman()).toBe('MMDCC');
  });
  ...
  test('3500', () => {
    ...
    expect(number.toRoman()).toBe('MMMD');
  });
});